...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    private void ValidateProductData()
    {
        ...
        if(ImageUri == null)
        {
            Toast.makeText(this, "Please add product Image to continue!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(Description))
        {
            Toast.makeText(this, "Please enter product description to continue!", Toast.LENGTH_SHORT).show();
        }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(SellerAddNewProductActivity.this, "Product has been added successfully!", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
